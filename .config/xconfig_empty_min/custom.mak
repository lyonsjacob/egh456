...
linker.cmd: package/cfg/empty_min_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/empty_min_pem4fcfg.cmd\)\"$""\"/home/jordikitto/ti_rtos/empty_min_EK_TM4C1294XL_TI/.config/xconfig_empty_min/\1\""' package/cfg/empty_min_pem4f.xdl > $@
